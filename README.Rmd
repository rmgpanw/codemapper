...
The goal of codemapper is to facilitate working with clinical codes used in electronic health records. This package relies in particular on the publicly available UK Biobank resource 592 - [Clinical coding classification systems and maps
